...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo e(route('referees.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="city_town" required>
                    </div>
                    <div class="mb-3">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\orpp4\resources\views/user/referees/create.blade.php ENDPATH**/ ?>