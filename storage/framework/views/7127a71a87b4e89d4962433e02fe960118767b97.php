...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="nav flex-column">
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('dashboard') ? 'active' : ''); ?>" href="/dashboard">Home</a>
            </li>
            <?php if(Auth::user()->is_staff && (Auth::user()->role == 'admin' || Auth::user()->role == 'hr')): ?>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('admin/job-listings') ? 'active' : ''); ?>" href="/admin/job-listings">Job Listings</a>
            </li>
            <?php else: ?>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('profile') ? 'active' : ''); ?>" href="/profile">Profile</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('applications') ? 'active' : ''); ?>" href="/applications">Job
                    Applications</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->is('my-applications') ? 'active' : ''); ?>" href="/my-applications">My
                    Applications</a>
            </li>
            <li class="nav-item">
    ...
    <div class="topbar">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
                <li class="dropdown-header">Welcome, <?php echo e(Auth::user()->name); ?></li>
...
</html><?php /**PATH C:\orpp4\resources\views/layout/main.blade.php ENDPATH**/ ?>