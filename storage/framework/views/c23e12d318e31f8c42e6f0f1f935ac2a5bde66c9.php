<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="/partners" class="nav-item nav-link <?php echo e(request()->is('partners') ? 'active' : ''); ?>">Partners</a>
            
            <a href="/contact" class="nav-item nav-link <?php echo e(request()->is('contact') ? 'active' : ''); ?>">Contact</a>
...
</nav><?php /**PATH C:\orpp4\resources\views/layout/navbar.blade.php ENDPATH**/ ?>